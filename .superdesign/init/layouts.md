# Meridian Layout Components

## AppShell

**Path:** `apps/web/src/components/app-shell.tsx`
**Description:** Main authenticated app layout with sidebar navigation, command palette trigger, AI assistant, and sign out.
...
**Path:** `apps/web/src/app/entities/layout.tsx`
...
**Path:** `apps/web/src/app/migration/layout.tsx`
